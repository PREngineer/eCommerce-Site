...
class AdministrationServices extends Page
{
  ...
  {
    parent::__construct();
    $this->title = $this->SiteSettings[0]['value'] . " - Administration > Services";
  }

  /**
   * getServices - Retrieves all the Services from the database
   *
   * @return array
   */
  public function getServices()
  {
    return $this->db->query_DB( "SELECT * FROM services ORDER BY name ASC" );
  }
      ...
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body tab-content py-4">
            <p class="text-danger">Deleting this service will also remove all Promotions associated to it.</p>
          </div>
          <div class="modal-body tab-content py-4">
        ...
        <div class="order-lg-2 mb-3 mb-lg-0 pt-lg-2">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb breadcrumb-dark">
              ...
              <li class="breadcrumb-item text-nowrap active" aria-current="page">Services</li>
            </ol>
          </nav>
        </div>
        <div class="order-lg-1 pr-lg-4 text-center text-lg-left">
          <h1 class="h3 text-dark mb-0">Services</h1>
        </div>
      </div>
    </div>';
    ...
    foreach( $addons as $addon ){
      $this->content .= '
                <tr>
                  ...
                  <td>
                    <a href="/Administration/Service/Edit/' . $addon['id'] . '" class="text-warning"><span class="ci-edit-alt"></span></a>
                  </td>
                  <td>
      ...
      $this->content .= '
          ...
          <script>
            function updateURL( id ){
              ...
              link.setAttribute("href", "/Administration/Service/Delete/" + id);
            }
          </script>
